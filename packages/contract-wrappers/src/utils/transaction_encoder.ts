...
export class TransactionEncoder {
     ...
     * @return Hex encoded abi of the function call.
     */
    public batchFillOrders(signedOrders: SignedOrder[], takerAssetFillAmounts: BigNumber[]): string {
     ...
     * @return Hex encoded abi of the function call.
     */
    public batchFillOrKillOrders(signedOrders: SignedOrder[], takerAssetFillAmounts: BigNumber[]): string {
        assert.doesConformToSchema('signedOrders', signedOrders, schemas.signedOrdersSchema);
        _.forEach(takerAssetFillAmounts, takerAssetFillAmount =>
            assert.isBigNumber('takerAssetFillAmount', takerAssetFillAmount),
        );
     ...
     * @return Hex encoded abi of the function call.
     */
    public batchFillOrdersNoThrow(signedOrders: SignedOrder[], takerAssetFillAmounts: BigNumber[]): string {
        assert.doesConformToSchema('signedOrders', signedOrders, schemas.signedOrdersSchema);
        _.forEach(takerAssetFillAmounts, takerAssetFillAmount =>
            assert.isBigNumber('takerAssetFillAmount', takerAssetFillAmount),
        );
     ...
     * @return Hex encoded abi of the function call.
     */
    public batchCancelOrders(signedOrders: SignedOrder[]): string {
        assert.doesConformToSchema('signedOrders', signedOrders, schemas.signedOrdersSchema);
     ...
     * @return Hex encoded abi of the function call.
     */
    public preSign(hash: string, signerAddress: string, signature: string): string {
     ...
     * @return Hex encoded abi of the function call.
     */
    public setSignatureValidatorApproval(validatorAddress: string, isApproved: boolean): string {
